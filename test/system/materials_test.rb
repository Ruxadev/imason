...
class MaterialsTest < ApplicationSystemTestCase
  ...
  test "should create material" do
    ...
    fill_in "Paid value", with: @material.paid_value
    fill_in "Phone", with: @material.phone
    fill_in "Project", with: @material.project_id
    fill_in "Rate", with: @material.rate
    fill_in "Store name", with: @material.store_name
